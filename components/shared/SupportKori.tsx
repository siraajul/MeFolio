  ...
  return (
    <div className={`w-full flex flex-col items-center justify-center gap-6 border-t border-neutral-200 dark:border-neutral-800 pt-16 ${className}`}>
       ...
       >
          ...
          {/* eslint-disable-next-line @next/next/no-img-element -- small static badge with a custom onError fallback; next/image's fixed dimensions don't fit the auto-width layout */}
          <img
