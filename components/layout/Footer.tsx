      ...
      <div className="border-t bg-background mt-0 relative">
        <div className="max-w-7xl flex flex-col justify-end mx-auto min-h-[15rem] sm:min-h-[20rem] md:min-h-[25rem] relative p-4 pb-10 pt-20">
          ...
          <div className="mt-20 md:mt-24 flex flex-col gap-2 md:gap-1 items-center justify-center md:flex-row md:items-center md:justify-between px-4 md:px-0">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground bg-foreground/5 px-3 py-1 rounded-full border border-border/50">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
              </span>
              <span className="font-medium tracking-tight">All Systems Operational</span>
            </div>
          </div>
        </div>
